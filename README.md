...
We showcase the viability of using OpenEvolve to generate low discrepancy sequencies for an arbitrary number of points, dimensions, and class of functions, We do this by using OpenEvolve to discover improved Sobol direction numbers of rQMC integration of various options: Asian, Lookback, Barrier, Basket, and Bermudan for 32 dimensions.
Checkout the [example](examples/qmc/) given for direction numbers for financial options for 32 dimensions.
